<%-- 
    Document   : Clientes
    Created on : 3/09/2022, 02:32:33 PM
    Author     : LC18
--%>
                ...
                <div class="card-body">
                    ...
                    <form action="Controlador?menu=Cliente" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="txtApellidoCliente" class="form-control">
                ...
                <table class="table table-hover">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <td class="table-primary text-center">APELLIDO</td>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center table-light">${cliente.getCodigoCliente()}</td>
                            <td class="text-center table-light">${cliente.getNombreCliente()}</td>
                            <td class="text-center table-light">${cliente.getApellidoCliente()}</td>
