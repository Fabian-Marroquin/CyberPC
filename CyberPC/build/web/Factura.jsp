                ...
                <div class="card-body">
                    ...
                    <form action="Controlador?menu=Factura" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <label>Código Forma de Pago:</label>
                        ...
                        <!-- <input type="submit" name="accion" value="Actualizar" class="bi bi-person-check-fill btn btn-success"> -->
                ...
                <table class="table table-hover">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <td class="table-primary text-center">CÓDIGO CLIENTE</td>
                            <td class="table-primary text-center">FORMA DE PAGO</td>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center table-light">${factura.getCodigoCliente()}</td>
                            <td class="text-center table-light">${factura.getCodigoFormaPago()}</td>
